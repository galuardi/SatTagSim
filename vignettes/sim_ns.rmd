...
sr |> 
  ...
  facet_wrap(~season)+
  geom_sf(myworld, mapping = aes(), fill = 'grey90', col = 'grey50')+
  geom_sf(box7 %>%  sf::st_as_sf(), mapping = aes(), col = 'salmon', lwd = 1, fill = 'transparent')+
...
datbox  =  get.first.box(simdat, 2000, box7, seas.len  =  npmon*3) # season length is number per month*3
boxtrans  =  get.trans.prob(datbox, nyears = 100, adims  =  c(7,7,4), perc  =  T)
...
# try new version of function... it works!!
datbox  =  get.first.box(simdat, 2000, box7, seas.len  =  npmon*3) # season length is number per month*3
boxtrans  =  get.trans.prob(datbox, nyears = 100, adims  =  c(7,7,4), perc  =  F)
