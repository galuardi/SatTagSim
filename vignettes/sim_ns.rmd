...
```{r, sst_pref_plot_12months, fig.cap = 'Number of months with suitable surface temperature. This plot shows a rolling average where the previous and next months binary values are taken into account. Doing this hedges against simulaied tracks becoming entrained in unllikely areas.'}
